...
!      - Modified to include number of turns 
!
!    How it works:
...
!    =================================================================
      subroutine coil_fields(ci1,rs1,rs2,zs1,zs2,xm,zm,Bxm,Bzm,Bs,rAm,nzc1,nrc1,nx,nz,xmin,xmax,zmin,zmax)
!    =================================================================
      implicit none
...
!f2py intent(inout) :: nx,nz
      double precision, intent(inout) :: xmin,xmax,zmin,zmax
!f2py intent(inout) :: xmin,xmax,zmin,zmax
!!!      integer, intent(inout), optional :: nxin, nzin
!!!f2py intent(inout) :: nxin,nzin
...
!            ## superpose coil currents for rAtheta, start ##
            ...
            do ic=0,nzc1
               ...
               do jc=0,nrc1
                  rds1 = rs1 + rsd1*dble(jc)
                  call rAtheta(elik2,elie2,rds1,dabs(x-xc1),z-zds1,ci1*csq1,at)
...
!     =================================================================
      SUBROUTINE rAtheta(elik2,elie2,rc,x,z,ci,at)
